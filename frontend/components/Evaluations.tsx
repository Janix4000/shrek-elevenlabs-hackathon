  ...
  return (
    <div className="h-full flex flex-col animate-fade-in">
      ...
      <div className="flex-1 grid grid-cols-12 gap-6 min-h-0">
        ...
        {/* List Pane */}
        <div className="col-span-4 bg-card border border-slate-200 rounded-xl overflow-hidden flex flex-col h-full">
            ...
            <div className="overflow-y-auto flex-1">
                {evaluations.map((evaluation) => (
                    <div key={evaluation.id} className="p-4 border-b border-slate-100 hover:bg-muted cursor-pointer transition-colors">
        ...
        <div className="col-span-8 bg-card border border-slate-200 rounded-xl flex flex-col h-full overflow-hidden">
             <div className="p-4 border-b border-slate-200 flex justify-between items-center bg-muted">
            ...
            <div className="flex-1 grid grid-cols-2 divide-x divide-slate-200 min-h-0">
                ...
                <div className="p-6 overflow-y-auto">
                    ...
                    <div className="space-y-4 text-sm">
                        <div className="flex gap-3">
                            ...
                            <div className="bg-muted p-3 rounded-lg rounded-tl-none border border-slate-100">
                        ...
                        <div className="flex gap-3 flex-row-reverse">
                            ...
                            <div className="bg-indigo-100 p-3 rounded-lg rounded-tr-none border border-indigo-200">
                                <p className="text-indigo-900 font-medium">I completely understand your concern. That sounds stressful. Let me pull up your account immediately to investigate.</p>
                                <div className="mt-1 flex items-center gap-1 text-xs text-indigo-600"><span className="font-semibold">Empathy Detected</span></div>
                            </div>
                        </div>
                ...
                {/* Auto Grader */}
                <div className="p-6 bg-muted/50 overflow-y-auto">
                    <h4 className="text-xs font-bold uppercase text-slate-400 tracking-wider mb-4">Auto-Rubric</h4>
                    
                    <div className="space-y-4">
                        <div className="bg-card p-4 rounded-lg border border-slate-200 shadow-sm">
